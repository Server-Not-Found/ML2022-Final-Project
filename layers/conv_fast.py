...
class conv():
    ...
    def forward(self, input):
        ...
        if self.padding == "SAME":
            ...
            self.x = numpy.lib.pad(input, ((0,0),(0,0),(p,p),(p,p)), "constant")
    ...
    def backward(self, eta, lr):
        ...
        if self.padding == "VALID":
            ...
            pad_eta = numpy.lib.pad(eta, ((0,0),(0,0),(p,p),(p,p)), "constant", constant_values=0)
            eta = pad_eta
    ...
    def checkpoints(self,layer_idx):
        save_path = "./checkpoints/conv"+str(layer_idx)+".npz"
        np.savez(save_path,weight=self.weight,bias=self.bias)
